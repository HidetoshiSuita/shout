...
RSpec.describe HashTagsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested hash_tag as @hash_tag" do
      hash_tag = HashTag.create! valid_attributes
      get :show, params: {id: hash_tag.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested hash_tag as @hash_tag" do
      hash_tag = HashTag.create! valid_attributes
      get :edit, params: {id: hash_tag.to_param}, session: valid_session
      expect(assigns(:hash_tag)).to eq(hash_tag)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new HashTag" do
        expect {
          post :create, params: {hash_tag: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved hash_tag as @hash_tag" do
        post :create, params: {hash_tag: invalid_attributes}, session: valid_session
        expect(assigns(:hash_tag)).to be_a_new(HashTag)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested hash_tag" do
        hash_tag = HashTag.create! valid_attributes
        put :update, params: {id: hash_tag.to_param, hash_tag: new_attributes}, session: valid_session
        hash_tag.reload
      ...
      it "assigns the requested hash_tag as @hash_tag" do
        hash_tag = HashTag.create! valid_attributes
        put :update, params: {id: hash_tag.to_param, hash_tag: valid_attributes}, session: valid_session
        expect(assigns(:hash_tag)).to eq(hash_tag)
      end
    ...
    context "with invalid params" do
      it "assigns the hash_tag as @hash_tag" do
        hash_tag = HashTag.create! valid_attributes
        put :update, params: {id: hash_tag.to_param, hash_tag: invalid_attributes}, session: valid_session
        expect(assigns(:hash_tag)).to eq(hash_tag)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested hash_tag" do
      hash_tag = HashTag.create! valid_attributes
      expect {
        delete :destroy, params: {id: hash_tag.to_param}, session: valid_session
      }.to change(HashTag, :count).by(-1)
    end
